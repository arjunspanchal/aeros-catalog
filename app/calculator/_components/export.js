...
// Admin-internal PDF — same layout but adds the cost breakdown (paper, glue,
// labour, wastage, setup, plate, mfg cost, margin, profit) so the team can
// review the numbers before sending the client-facing version.
