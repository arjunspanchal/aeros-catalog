          ...
          <>
            ...
            <Card title="Export">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                ...
                <button
                  title="Customer-facing — only the rate, specs, weight, box, and rate curve. No internal margins or cost breakdown."
              ...
              <p className="text-xs text-gray-400 mt-2 dark:text-gray-500">
                Use <strong>Client PDF</strong> for what you send the customer; <strong>Admin PDF</strong> includes the cost breakdown for internal review.
              </p>
            </Card>
