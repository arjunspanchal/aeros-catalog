...
import { StageBadge, formatDate, inputCls } from "@/app/orders/_components/ui";
                ...
                return (
                  <tr key={j.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/40">
                    <td className="px-4 py-2 font-mono text-xs">
                      <Link href={`/orders/manager/${j.id}`} className="text-blue-600 hover:underline dark:text-blue-400">
                        {j.jNumber}
                      </Link>
                    </td>
