...
import { inputCls, labelCls, formatDateTime } from "@/app/factoryos/_components/ui";
...
export default function CustomerPOsClient({ initialPOs }) {
  ...
  async function upload(e) {
    ...
    const res = await fetch("/api/factoryos/customer-pos", {
      method: "POST",
    ...
    const list = await fetch("/api/factoryos/customer-pos").then((r) => r.json());
    setPos(list.pos || []);
