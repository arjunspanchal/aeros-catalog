...
export const TABLES = {
  ...
  machines: () => process.env.AIRTABLE_ORDERS_MACHINES_TABLE || "Machines",
  productionRuns: () => process.env.AIRTABLE_ORDERS_RUNS_TABLE || "Production Runs",
  rmConsumption: () => process.env.AIRTABLE_ORDERS_CONSUMPTION_TABLE || "RM Consumption",
  employees: () => process.env.AIRTABLE_ORDERS_EMPLOYEES_TABLE || "Employees",
  attendance: () => process.env.AIRTABLE_ORDERS_ATTENDANCE_TABLE || "Attendance",
};
