// HMAC-signed session cookie for the Orders module.
// Payload: { role, email?, name?, userId?, clientIds?: string[], exp }

import crypto from "node:crypto";

const COOKIE_NAME = "aeros_factoryos_session";
...
export { generateOtp } from "@/lib/shared/otp";
